...
${OBJECTDIR}/p20.o: p20.asm  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/p20.o.d 
	@${RM} ${OBJECTDIR}/p20.o 
	@${FIXDEPS} dummy.d -e "${OBJECTDIR}/p20.err" $(SILENT) -c ${MP_AS} $(MP_EXTRA_AS_PRE) -d__DEBUG -d__MPLAB_DEBUGGER_SIMULATOR=1 -q -p$(MP_PROCESSOR_OPTION)  -l\"${OBJECTDIR}/p20.lst\" -e\"${OBJECTDIR}/p20.err\" $(ASM_OPTIONS)    -o\"${OBJECTDIR}/p20.o\" \"p20.asm\" 
